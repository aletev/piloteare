...
if cant_resp_pub == tot_pub and tot_pub > 0:
    ...
    # Opción para compartir resultados en redes sociales o enviar a amigos vía correo electrónico
    if st.button("💬 Compartir Resultados"):
        st.markdown(
            f"""
            <p style='color: #f3f4f6; font-size: 1.2rem;'>Comparte tus impresiones con los demás!</p>
            """,
            unsafe_allow_html=True,
        )
