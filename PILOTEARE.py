...
# 🔐 3. CONTROL DE ACCESO (LOGIN BÁSICO SEGURO)
...
# --- CONTROL DE PESTAÑAS PRINCIPALES (MÓDULO DE NAVEGACIÓN DE LA APP) ---
...
with tab_sistema:
    ...
    with st.form("vuelo_oficial_form", clear_on_submit=True):
        ...
        with col1:
            ...
            instructor = st.text_input("Instructor a Cargo", placeholder="Ej: Juan Arrascaeta, Guille...", disabled=not es_admin)
...
with tab_manual:
    ...
    st.markdown("Evoluciones de radio VHF, procedimientos operativos y checklists del Cessna 150/152 embebidos de manera directa.")
    
    # 📝 INYECCIÓN COMPLETA DEL MANUAL HTML DENTRO DEL COMPONENTE SEGURO
    html_manual_source = """
    <!DOCTYPE html>
    <html>
    <head>
    ...
    <body>
        ...
        <div id="t-briefing" class="content-pane active">
            ...
            <ul>
                ...
                <li>Verificar parámetros normales de motor (<strong>Presión, Temperatura y RPM</strong>). Si están estándar, continuar despegue.</li>
            ...
            <div class="box-emergency">
                ...
                <p><strong>Antes de la rotación:</strong> Reducir potencia al mínimo y frenar firmemente en la pista disponible.</p>
                <p><strong>Posterior a la rotación con pista remanente:</strong> Velocidad de planeo de <strong>60 kt o 70 mph</strong>, nariz abajo, aterrizar en pista remanente y retraer flaps al tocar el suelo.</p>
                <p><strong>Sin pista remanente:</strong> Resolver estrictamente al frente, buscando campo a no más de 45° de margen lateral.</p>
            </div>
            <div class="box-highlight">
                <p><strong>Jerarquía de Cabina:</strong> Avión de quien vuela (PF), el copiloto asiste. Volando con instructor, la emergencia real es siempre del comandante instructor, la simulada del alumno.</p>
            </div>
        </div>
        ...
        <div id="t-ascenso" class="content-pane">
            ...
            <div class="box-highlight">
                <ol>
                    <li><strong>Retracción de Flaps</strong> (si se usaron).</li>
                    <li><strong>Reducción de motor a 2500 RPM</strong> para proteger el motor en ascenso continuado.</li>
                </ol>
            </div>
            <p>Mantener actitud constante ascendiendo a <strong>70 mph (60 kts)</strong> con potencia fija en 2500 RPM.</p>
            <h3>Secuencia para Nivelar el Avión (Crucero)</h3>
            <ol>
                <li><strong>Actitud:</strong> Bajar la nariz buscando la línea de referencia con el horizonte.</li>
                <li><strong>Potencia:</strong> Ajustar acelerador clavado a <strong>2300 RPM</strong>.</li>
                <li><strong>Compenso (Trim):</strong> Quitar presiones del comando con la rueda del trim del timón de profundidad.</li>
            </ol>
        </div>

        <div id="t-circuito" class="content-pane">
            <h2>Circuito de Tránsito de Aeródromo</h2>
            <p>Patrón reglamentario e instrumental en el CUA para entrenamiento de aterrizajes de precisión.</p>
            <div class="box-highlight">
                <ul>
                    <li><strong>Altitud del circuito:</strong> Fija a <strong>500 pies (500 ft)</strong>.</li>
                    <li><strong>Separación lateral:</strong> Mantener una distancia constante de <strong>500 metros</strong> paralela a la pista.</li>
                </ul>
            </div>
            <h3>Evolución de Piernas</h3>
            <p>Tránsito coordinado dividiéndose en Inicial de la cabecera activa, Pierna Básica y la Final de estabilización final hacia los Touch & Go.</p>
        </div>

        <div id="t-maniobras" class="content-pane">
            <h2>Maniobras de Salida e Ingreso</h2>
            <h3>Abandono del Circuito</h3>
            <p>Efectuar un primer viraje inicial ordenado de <strong>90°</strong> saliendo del eje de pista activo, seguido de una corrección complementaria de <strong>45°</strong> para franquear los límites locales de tránsito.</p>
            <h3>Ingreso al Circuito ("Gota de Agua")</h3>
            <p>Aproximarse cruzando la vertical de la referencia geográfica de las vías a una altitud mandatoria de <strong>1000 pies (1000 ft)</strong>. Iniciar descenso controlado interceptando las líneas hasta establecer los <strong>500 pies</strong> acoplándose directo en la pierna Inicial.</p>
        </div>

        <div id="t-radio" class="content-pane">
            <h2>Guía de Comunicaciones VHF Oficial</h2>
            <div class="box-highlight">
                <p><strong>Pilar Estructural de la Transmisión:</strong> 1. LUGAR (A quién hablo) | 2. MATRÍCULA (Quién soy) | 3. INTENCIONES (Qué hago / hacia dónde voy).</p>
            </div>
            <h3>Mensajes en Ruta:</h3>
            <div class="radio-string">"Matanza - LV-CQU - cruza su vertical por el oeste con 1000 pies."</div>
            <div class="radio-string">"Chascomús - LV-CQU - proveniente del norte a 5 millas del suyo, con intención de incorporarse a inicial de pista 04/22."</div>
            
            <h3>Secuencia Operativa de Reportes de Tránsito en Matanza:</h3>
            <ol>
                <li><strong>Rodaje:</strong> "Matanza - *Matrícula* - rueda de línea de pista / hangares a punto de espera de pista 17/35."</li>
                <li><strong>Despegue:</strong> "Matanza - *Matrícula* - ocupa y despega pista 17/35."</li>
                <li><strong>Retorno de zona:</strong> "Matanza - *Matrícula* - de zona de trabajo a su vertical con 1000 pies."</li>
                <li><strong>En las vías:</strong> "Matanza - *Matrícula* - en descenso para incorporarse a inicial de 17/35."</li>
                <li><strong>Tramos finales:</strong> Reportar tramos correlativos de "Inicial", "Básica" y "Final de 17/35".</li>
                <li><strong>Pista libre:</strong> "Matanza - *Matrícula* - libera pista 17/35."</li>
            </ol>
        </div>
    ...
    # Renderizar el componente HTML de forma adaptiva para la vista móvil
    st.components.v1.html(html_manual_source, height=520, scrolling=True)
